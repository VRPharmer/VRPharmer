    ...
    public class VRTK_UICanvas : MonoBehaviour
    {
        ...
        protected virtual void SetupCanvas()
        {
            ...
            if (canvas.gameObject.GetComponent<BoxCollider>() == null)
            {
                ...
                canvasBoxCollider.size = new Vector3(canvasSize.x, canvasSize.y, 1);
                canvasBoxCollider.center = new Vector3(canvasSize.x / 2 - canvasSize.x * pivot.x, canvasSize.y / 2 - canvasSize.y * pivot.y, 1);
